        ...
        <Routes>
          ...
          <Route path="/video" element={
            <ProtectedRoute>
              {
                /* 
                  Allow direct access for now, but ideally check permissions.
                  Passing user email to identify in the room.
                */
              }
              <VideoRoom
                roomName="talkme-global-room"
          ...
          {/* TEMPORARY DEMO ROUTE (NO AUTH) */}
          <Route path="/demo" element={
            <ChatInterface session={{ user: { id: 'demo-investor', email: 'investor@demo.com' } }} />
          } />
        </Routes>
      </div>
    </Router>
